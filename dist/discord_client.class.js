...
class Discord_client {
    ...
    set_user_string() {
        this.watching_users_string = '';
        if (!util_1.isUndefined(this.viewers) && !util_1.isNull(this.viewers)) {
    ...
    update_msg() {
        this.msg = {
            ...
            shutdown_error: {
                embed: {
                    color: 0xff0000,
                    title: 'I can\'t do that, ' + this.get_num_watching() + ' still watching.'
                }
            },
            no_one_watching: {
                embed: {
...
exports.discord_client = new Discord_client();
